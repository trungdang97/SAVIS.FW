    ...
    .directive('imageCrop', function() {
      ...
      return {
        ...
        link: function (scope, element, attributes) {
          ...
          scope.width = parseInt(scope.step[0], 10) || 300;
          scope.height = parseInt(scope.step[1], 10) || 300;
          ...
          // ---------- EVENT HANDLERS ---------- //
		  fileReader.onload = function (base64ImageSrc) {
