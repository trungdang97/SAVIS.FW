        ...
        .directive('redactor', ['$timeout', function($timeout) {
            ...
            var init = function () {
                ...
                $.fn.redactor = function (options) {
                    console.log('START REDACTOR FUNC');
                    var val = [];
            ...
            return {
                ...
                link: function(scope, element, attrs, ngModel) {
                    ...
                    $timeout(function() {
                        console.log('START REDACTOR EDITOR FUNC');
                        console.log($_element.redactor);

                        if (typeof $_element.redactor == 'undefined') {
                            init();
                        }
