...
(function(angular) {
    var apiUrl = "http://localhost:1111/";
    var contentFolderUrl = "http://localhost:8022/ContentFolder/";

    var editorWysiwyg = angular.module('ngWYSIWYG', ['ngSanitize']);
    ...
    var editorTemplate = "<div class=\"tinyeditor\">" +
        ...
        "<div ng-switch=\"editMode\" ng-click=\"editMode = !editMode\" class=\"toggle\"><span ng-switch-when=\"true\">Design</span><span ng-switch-default>View Html</span></div>" +
        "</div>" +
        "</div>";

    //debug sanitize
    editorWysiwyg.config([
        '$provide',
    ...
    editorWysiwyg.directive('wframe', [
        '$compile', '$timeout', '$sanitize',
    ...
    editorWysiwyg.directive("ceResize", [
        '$document',
        function($document) {
    ...
    editorWysiwyg.directive('colorsGrid', [
        '$compile', '$document',
    ...
    editorWysiwyg.directive('symbolsGrid', [
        '$compile', '$document', '$sce',
    ...
    editorWysiwyg.directive('wysiwygEdit', [
        '$compile', '$timeout', '$q', '$modal', '$http',
        function($compile, $timeout, $q, $modal, $http) {
            var linker = function(scope, $element, attrs, ctrl) {
                ...
                scope.panelButtons = {
                    ...
                    imagemanager: "<div class=\"tinyeditor-control-ex\" title=\"Image Manager\" ng-click=\"imgaeManager()\"><i class=\"fa fa-picture-o\"></i></div>",
                    videomanager: "<div class=\"tinyeditor-control-ex\" title=\"Video Manager\" ng-click=\"imgaeManager()\"><i class=\"fa fa-video-camera\"></i></div>",
                    musicmanager: "<div class=\"tinyeditor-control-ex\" title=\"Music Manager\" ng-click=\"imgaeManager()\"><i class=\"fa fa-headphones\"></i></div>",
                    ...
                    font: "<select class=\"form-control tinyeditor-font\" style=\"width: auto;height: 30px;\" ng-model=\"font\" ng-options=\"a as a for a in fonts\" ng-change=\"fontChange()\"><option value=\"\">Font</option></select>",
                    size: "<select class=\"form-control tinyeditor-size\" style=\"width: auto;height: 30px;\" ng-model=\"fontsize\" ng-options=\"a.key as a.name for a in fontsizes\" ng-change=\"sizeChange()\"><option value=\"\">Size</option></select>",
                    format: "<select class=\"form-control tinyeditor-style\" style=\"width: auto;height: 30px;\" ng-model=\"textstyle\" ng-options=\"s.key as s.name for s in styles\" ng-change=\"styleChange()\"><option value=\"\">Style</option></select>",
                };
                    ...
                    modalInstance.result.then(function(fileItem) {
                        ...
                        angular.forEach(fileItem.Data, function(item) {
                            ...
                            if (item.AbsolutePath != null && item.AbsolutePath != "") {
                                val += '<a href="' + contentFolderUrl + item.AbsolutePath + '" data-lightbox="example"><img src="' + contentFolderUrl + item.AbsolutePath + '"></a><br>';
                            }
                        });

                        console.log(scope.FileList);

                        //val = fileItem.Data[0].AbsolutePath;
